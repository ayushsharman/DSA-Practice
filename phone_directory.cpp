...
int main()
{
    vector<string> contactList = {"John", "Alice", "Bob", "Charlie", "David", "Eve"};
    string queryStr = "Al";
    ...
    {
        string contactLowerCase = contact;
        transform(contactLowerCase.begin(), contactLowerCase.end(), contactLowerCase.begin(), ::tolower);

        if (contactLowerCase.find(queryStr) != string::npos)
        {
